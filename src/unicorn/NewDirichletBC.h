...
#ifndef __NEW_DIRICHLET_BC_H
#define __NEW_DIRICHLET_BC_H
...
namespace dolfin
{
  ...
  ///
  /// A NewDirichletBC is specified by a Function, a Mesh,
  ...
  class NewDirichletBC : public BoundaryCondition
  {
  public:

    /// Create boundary condition for sub domain
    NewDirichletBC(Function& g,
                Mesh& mesh,
